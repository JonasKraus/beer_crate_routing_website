...
class databaseManager extends databaseConstants {
    ...
    public function getUsersProgress () {
        ...
        $str = "<br>Diese Tabelle zeigt die Anzahl an Teilnehmer und deren aktuellen Fortschritt:<br><br><table style='border-collapse: collapse; border: 1px solid black' cellpadding='10' width='25em'>";
